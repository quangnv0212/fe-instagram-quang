...
const ChatoptionSheet = (props, ref) => {
  ...
  const snapPoints = useMemo(
    () => [
      props.block === false ? 100 : props.deleteChat === false ? 130 : 180,
    ],
    []
  );
  ...
  return (
    ...
    >
      <View style={GlobalStyleSheet.container}>
        ...
        {props.block === false ? null : (
          <TouchableOpacity style={GlobalStyleSheet.TouchableOpacity}>
            <Image style={GlobalStyleSheet.image} source={IMAGES.block} />
            <Text style={GlobalStyleSheet.text}>Block</Text>
          </TouchableOpacity>
        )}

        {props.deleteChat === false ? null : (
          <TouchableOpacity style={GlobalStyleSheet.TouchableOpacity}>
            <Image
